<div>
    ...
    <footer
        ...
        @class([
            ...
            theme_style($theme, 'footer.footer', 'border-x border-b rounded-b-lg border-b border-pg-primary-200'),
            theme_style($theme, 'footer.footer_with_pagination', 'md:flex md:flex-row w-full items-center py-3 bg-white overflow-y-auto pl-2 pr-2 relative') => blank(data_get($setUp, 'footer.pagination')),
        ])
    >
