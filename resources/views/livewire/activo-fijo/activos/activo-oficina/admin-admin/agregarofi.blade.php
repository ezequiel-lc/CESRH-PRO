...
@section('js')
    ...
    <script>
        ...
        function initializeSelect2(selector) {
            ...
            console.log('Select2 aplicado a:', selector, 'Contenedor generado:', $element.next('.select2-container')
                .length > 0);
        }
        ...
        <div class="my-5">
            ...
            <div class="bg-white rounded-b-lg shadow-2xl p-6">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div class="my-2">
                        ...
                        <input type="text" wire:model="activo.numero_activo"
                            class="block w-full border-2 px-2 py-2 text-sm sm:text-md rounded-md my-2 text-black"
                            id="numero_activo" placeholder="Ingresa el número de activo">
                        @error('activo.numero_activo')
                            <span class="text-red-500 text-xs">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="my-2 sm:col-span-2">
                        <label for="descripcion" class="text-gray-700 font-bold text-xl">Descripción del
                            Producto</label>
                ...
                <div class="flex justify-center mt-4">
                    <button wire:click="saveActivoOf()"
