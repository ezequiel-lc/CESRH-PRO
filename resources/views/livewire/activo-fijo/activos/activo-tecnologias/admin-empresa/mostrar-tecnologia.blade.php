<div>
    ...
    <div class="bg-gradient-to-r from-[#1763A6] to-[#1EA4D9] text-white font-bold text-xl py-4 px-6 rounded-t-lg shadow-lg flex items-center justify-between">
        ...
        <div class="flex items-center space-x-4">
            ...
            <!-- Botón Editar -->
            <button onclick="window.location.href='{{ route('mostrarnotaem') }}'" class="text-white font-bold p-2 rounded-md flex items-center justify-center hover:bg-[#1763A6] transition duration-300">
