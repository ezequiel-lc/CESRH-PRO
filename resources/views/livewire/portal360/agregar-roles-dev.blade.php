<div>
    <div class="w-full max-w-4xl mx-auto bg-white shadow-lg rounded-sm border border-gray-200 p-8">
        <header class="px-5 py-4 border-b border-gray-100">
            <h2 class="font-semibold text-gray-800 text-xl">Agregar Rol</h2>
        </header>

        <!-- Formulario -->
        <form wire:submit.prevent="saveRol" class="space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Nombre -->
                <div>
                    <label class="block text-sm font-medium text-gray-700">Nombre</label>
                    <input type="text"
                        wire:model="rolesdev.name"
            ...
            <div class="flex justify-end gap-2 mt-4">
                <a
                    href="{{ route('portal360.mostrarRoles') }}"
