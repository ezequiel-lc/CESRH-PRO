<div>
    <div class="w-full max-w-4xl mx-auto bg-white shadow-lg rounded-sm border border-gray-200 p-8">
        <header class="px-5 py-4 border-b border-gray-100">
            <h2 class="font-semibold text-gray-800 text-xl">Editar Roles</h2>
        </header>

        <form wire:submit.prevent="editRolesdev" class="space-y-6 p-6">
            ...
            <div class="flex justify-end space-x-4">
                <a href="{{ route('portal360.mostrarRoles') }}" 
