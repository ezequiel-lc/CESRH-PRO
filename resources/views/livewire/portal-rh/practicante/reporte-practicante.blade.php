    ...
    <div>
        ...
        <table class="table">
            <tr>
                ...
                <th>Clave del practicante</th><td>{{ $practicante->clave_practicante ?? 'Sin clave' }}</td>
            </tr>
            <tr>
                <th>NSS</th><td>{{ $practicante->numero_seguridad_social }}</td>
                <th>Fecha de Nacimiento</th><td>{{ $practicante->fecha_nacimiento }}</td>
            </tr>
            <tr>
                <th>Lugar de Nacimiento</th><td>{{ $practicante->lugar_nacimiento }}</td>
                <th>Estado</th><td>{{ $practicante->estado }}</td>
            </tr>
            <tr>
                <th>Código Postal</th><td>{{ $practicante->codigo_postal }}</td>
                <th>Ocupación</th><td>{{ $practicante->ocupacion }}</td>
            </tr>
            <tr>
                <th>Sexo</th><td>{{ $practicante->sexo }}</td>
                <th>Número celular</th><td>+52 | {{ $practicante->numero_celular }}</td>
            </tr>
            <tr>
                <th>CURP</th><td>{{ $practicante->curp }}</td>
                <th>RFC</th><td>{{ $practicante->rfc }}</td>
            </tr>
        </table>
