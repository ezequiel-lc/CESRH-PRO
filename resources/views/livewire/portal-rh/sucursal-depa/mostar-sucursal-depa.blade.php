<div class="p-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-semibold text-gray-800">Relación de Sucursales con Departamentos</h1>
        <button wire:click="redirigir" class="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded">
            Relacionar Sucursal con Departamento
        </button>
    </div>
        ...
        <div class="relative top-40 mx-auto shadow-xl rounded-md bg-white max-w-md">
            ...
            <div class="p-6 pt-0 text-center">
                ...
                <h3 class="text-xl font-normal text-gray-500 mt-5 mb-6">¿Estás seguro de que deseas eliminar esta
                    relación?</h3>
                <button wire:click="deleteSucursalDepa"
    ...
    <!--   -->
    <livewire:portalrh.sucursaldepa.sucursal-depa-table/>
</div>
