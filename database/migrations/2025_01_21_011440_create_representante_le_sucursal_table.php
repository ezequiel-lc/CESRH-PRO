...
return new class extends Migration
{
    ...
    {
        Schema::create('representante_le_sucursal', function (Blueprint $table) {
            $table->id();
    ...
    public function down(): void
    {
        ...
        Schema::table('representante_le_sucursal', function (Blueprint $table) {
            $table->dropForeign(['sucursal_id']);
        });


        Schema::dropIfExists('representante_le_sucursal');
    }
};
