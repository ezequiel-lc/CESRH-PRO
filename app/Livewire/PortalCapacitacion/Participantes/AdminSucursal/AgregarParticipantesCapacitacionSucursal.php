...
class AgregarParticipantesCapacitacionSucursal extends Component
{
    public $capacitacion;
    public $usuarios;
    ...
    {
        return view('livewire.portal-capacitacion.participantes.admin-sucursal.agregar-participantes-capacitacion-sucursal', [
