...
class EditarParticipantesCapacitacion extends Component
{
    public $capacitacion;
    ...
    {
        return view('livewire.portal-capacitacion.participantes.admin-general.editar-participantes-capacitacion', [
