...
class EditarParticipantesCapacitacionEmpresa extends Component
{
    public $capacitacion;
    ...
    {
        return view('livewire.portal-capacitacion.participantes.admin-empresa.editar-participantes-capacitacion-empresa', [
