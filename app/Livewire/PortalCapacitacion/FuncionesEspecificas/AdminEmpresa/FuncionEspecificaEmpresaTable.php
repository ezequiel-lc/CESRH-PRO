...
final class FuncionEspecificaEmpresaTable extends PowerGridComponent
{
    use WithExport;
    ...
    public function datasource(): Builder
    {
        ...
        return FuncionEspecifica::query()
            ...
            ->where('funciones_esp.empresa_id', $user->empresa_id); // Filtra por empresa del usuario
    }
    ...
    public function actions(FuncionEspecifica $row): array
    {
        return [
            Button::add('edit')
                ...
                ->route('editarFuncionesEspecificasEmpresa', ['id' => Crypt::encrypt($row->id)]),
