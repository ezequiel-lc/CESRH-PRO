...
class EditarPerfilPuestoEmpresa extends Component
{
    ...
    {
        return view('livewire.portal-capacitacion.perfil-puesto.admin-empresa.editar-perfil-puesto-empresa')->layout("layouts.portal_capacitacion");
    }
}
