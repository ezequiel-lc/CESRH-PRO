...
class AgregarPerfilPuestoEmpresa extends Component
{
    public $perfil = [];
    public $empresas = [];
    public $sucursales = [];
    ...
    public function mount(){
        ...
        // Cargar automáticamente las sucursales de la empresa
    ...
    public function savePerfil()
{
    ...
    {
        return view('livewire.portal-capacitacion.perfil-puesto.admin-empresa.agregar-perfil-puesto-empresa')->layout("layouts.portal_capacitacion");
    }
}
