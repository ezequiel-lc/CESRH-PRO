...
final class ResponsabilidadUniversalSucursalTable extends PowerGridComponent
{
    ...
    public function datasource(): Builder
    {
        ...
        return ResponsabilidadUniversal::query()
            ...
            ->where('respons_univ.sucursal_id', $user->sucursal_id);
    }
    ...
    public function actions(ResponsabilidadUniversal $row): array
    {
        return [
            Button::add('edit')
                ...
                ->route('editarResponsabilidadesUniversalesSucursal', ['id' => Crypt::encrypt($row->id)]),
