...
final class RelacionExternaEmpresaTable extends PowerGridComponent
{
    use WithExport;
    ...
    public function datasource(): Builder
    {
        ...
        ->where('relaciones_externas.empresa_id', $user->empresa_id);
    ...
    public function actions(RelacionExterna $row): array
    {
        return [
            Button::add('edit')
                ...
                ->route('editarRelacionesExternasEmpresa', ['id' => Crypt::encrypt($row->id)]),
