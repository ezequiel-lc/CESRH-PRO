...
final class HabilidadTecnicaSucursalTable extends PowerGridComponent
{
    use WithExport;
    ...
    public function datasource(): Builder
    {
        ...
        ->where('formaciones_tecnicas.sucursal_id', $user->sucursal_id);
    }
    ...
    public function actions(FormacionHabilidadTecnica $row): array
    {
        return [
            Button::add('edit')
                ...
                ->route('editarHabilidadesTecnicasSucursal', ['id' => Crypt::encrypt($row->id)]),
