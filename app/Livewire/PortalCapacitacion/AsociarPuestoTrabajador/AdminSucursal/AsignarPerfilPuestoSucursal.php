...
class AsignarPerfilPuestoSucursal extends Component
{
    public $usuario;
    public $perfiles = [];
    ...
    {
        return view('livewire.portal-capacitacion.asociar-puesto-trabajador.admin-sucursal.asignar-perfil-puesto-sucursal')
