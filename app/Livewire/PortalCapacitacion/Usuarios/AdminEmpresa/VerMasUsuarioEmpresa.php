...
class VerMasUsuarioEmpresa extends Component
{
    ...
    {
        return view('livewire.portal-capacitacion.usuarios.admin-empresa.ver-mas-usuario-empresa')->layout("layouts.portal_capacitacion");
    }
