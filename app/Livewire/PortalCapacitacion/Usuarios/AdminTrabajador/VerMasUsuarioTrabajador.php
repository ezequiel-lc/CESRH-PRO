...
class VerMasUsuarioTrabajador extends Component
{
    ...
    {
        return view('livewire.portal-capacitacion.usuarios.admin-trabajador.ver-mas-usuario-trabajador')->layout("layouts.portal_capacitacion");
    }
