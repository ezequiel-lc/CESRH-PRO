...
class EditarRelacionesSucursales extends Component
{
    ...
    public function editarRelacionesSucursales(){
        try {
            $this->validate([
    ...
    {
        return view('livewire.portal360.relaciones.relaciones-sucursal.editar-relaciones-sucursales')->layout('layouts.portal360');
    }
