...
namespace App\Livewire\Portal360\Empresa\EmpresaSucursal;
...
final class MostrarEmpresaSucursalTable extends PowerGridComponent
{
    public string $tableName = 'mostrar-empresa-sucursal-table-7j07sl-table';
